...
namespace Space3x.Core.Extensions
{
    ...
    {
        /// <summary>
        /// Declared as internal to avoid unnecessary polluting since usage other than the one provided in <c>AddCopyAsNewComponent</c> seems meaningless.
        /// <see cref="GameObjectExtensions.AddCopyAsNewComponent{T}"/>
        /// Source: <a href="https://stackoverflow.com/a/62553770"/>
        /// </summary>
